...
![1593331866389](C:\Users\xiongchaoxi\AppData\Roaming\Typora\typora-user-images\1593331866389.png)
...
![1593331970616](C:\Users\xiongchaoxi\AppData\Roaming\Typora\typora-user-images\1593331970616.png)
...
###  1.java是如何解决hashmap的线程不安全的问题的？言外之意 线程安全的都有哪些




### 2.redis主从是如何备份数据的，讲讲具体过程
...
### 5.介绍一下jvm内存结构（具体到每个结构的内部结构），哪些情况下会产生oom异常



### 6.实现线程安全有哪几种方式？具体问到了reentrantlock的实现原理?


### 7.哨兵模式，讲一讲哨兵发出的通信有几种方式？ 我就答出了pingpong·······